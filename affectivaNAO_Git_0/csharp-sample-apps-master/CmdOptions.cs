...
namespace csharp_sample_app
{
    class CmdOptions
    {
        [Option('i', "input", Required = false, HelpText = "Input stream to be processed. Set the input to \"camera\" if you want to use the live camera stream.")]
        public string Input { get; set; }

        [Option('d', "data", Required = false, HelpText = "Data Directory.")]
